<template> 
  <div class="app-container">
        ...
        <el-table-column label="商家名称" align="center">
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" content="点击跳转订单列表" placement="top">
              <el-button  @click="jumpSearchOrder"  type="text" size="small">{{scope.row.name}}</el-button>
            </el-tooltip>
            </template>
        </el-table-column>
    ...
    <el-dialog
      ...
      width="40%">
      <el-form :model="businessInfo"
               ref="roleForm"
               label-width="150px" size="small">
        <el-form-item label="店铺名称：">
          <el-input v-model="businessInfo.businessName" style="width: 250px"></el-input>
        </el-form-item>
        ...
        <el-form-item label="商家电话：">
          <el-input v-model="businessInfo.phone"
                    type="text"
                    :rows="5"
                    style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="url：">
          <el-input v-model="businessInfo.url"
                    type="textarea"
                    :rows="5"
                    style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="备注：">
          <el-input v-model="businessInfo.remark"
                    type="textarea"
                    :rows="5"
                    style="width: 250px"></el-input>
        </el-form-item>
