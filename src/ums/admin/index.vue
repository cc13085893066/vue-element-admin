    ...
    >
      ...
      >
        <el-form-item label="用户名：">
          <el-input v-model="userInfo.userName" style="width: 250px" />
        </el-form-item>
        <el-form-item label="手机号：">
          <el-input v-model="userInfo.phoneNumber" style="width: 250px" />
        </el-form-item>
        <el-form-item label="密码：">
          <el-input v-model="userInfo.password" type="password" style="width: 250px" />
        </el-form-item>
